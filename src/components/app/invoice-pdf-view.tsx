...
export function InvoicePDFView({ client, invoice, profile, settings, onReady }: InvoicePDFViewProps) {
  ...
  return (
    <div className="invoice-pagination-wrapper" onLoad={() => onReady?.()}>
      {pages.map((pageRows, pageIndex) => (
        <div 
          key={pageIndex}
          className="print-page bg-white p-0 text-black shadow-none border mb-8"
        >
          {/* Main Content Area */}
          <div className="p-10">
          ...
          {/* Footer Section pinned to bottom of page container */}
          <div className="p-10 footer-section mt-auto">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="text-right flex flex-col justify-end">
                      ...
                      {settings?.showWatermark && (
                        <p className="text-[8px] text-gray-300 mt-2">Dulus Business Manager</p>
                      )}
                    </div>
                  </div>
                </div>
